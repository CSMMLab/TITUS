...
W_dlr = readdlm("output/liverSmallPerson/W_csd_1stcollision_DLRA_Rank50nx200ny200nPN21eMax2.0rhoMin0.1epsAdapt0.001.txt", Float64)
...
doseFull = readdlm("output/liverSmallPerson/dose_csd_1stcollision_nx200ny200nPN21eMax2.0rhoMin0.1.txt", Float64)
dose = readdlm("output/liverSmallPerson/dose_csd_1stcollision_nx200ny200nPN21eMax2.0rhoMin0.10epsAdapt.001.txt", Float64)
dose_DLR = readdlm("output/liverSmallPerson/dose_csd_1stcollision_DLRA_Rank50nx200ny200nPN21eMax2.0rhoMin0.1.txt", Float64)
dose_DLRM = readdlm("output/liverSmallPerson/dose_csd_1stcollision_DLRAM_Rank50nx200ny200nPN21eMax2.0rhoMin0.1.txt", Float64)
